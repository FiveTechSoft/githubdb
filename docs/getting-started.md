...
You can also create or edit `data/*.json` files by hand or through Git — they are plain, human-readable JSON. See [Data format](data-format.html).

## Next steps

- [API reference](api.html) — payload fields, parameters, result format
- [Vector search](vectors.html) — add semantic search with automatic embeddings
